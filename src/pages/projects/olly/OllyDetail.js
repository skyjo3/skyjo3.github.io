          ...
          <div className={styles.olly}>
            <section id="overview" ref={sectionRefs.current.overview}>
              ...
              <div className={styles.overviewContainer}>
                <div>
                  <h2>Overview</h2>
                  <p>Olly is an Generative AI-empowered website that allows people to rediscover and interact with their e-book highlights. Offering thought-provoking prompts tailored to individual knowledge preferences, users reconnect with significant content, documenting reflections to advance their understanding.</p>
                </div>
                <div>
                  <h2>Team</h2>
            ...
            <section id="empathize" ref={sectionRefs.current.empathize}>
                ...
                <div className={styles.funfactContainer}>
                  ...
                  <div>
                    <h5>Fun Fact</h5>
                    <p>From this stage, we have also renamed our project to 'Olly' to better emphasize the integration of 'quotes' and 'dialogue'.</p>
                  </div>
                </div>
            </section>
            <section id="design" ref={sectionRefs.current.design}>
              ...
              <p>After the brainstorming session, we decided to have <b>5 key features</b> of Olly:</p>
              <ol>
              ...
              <p>As the screenshot below shows, later we prototyped and designed our Olly website on Figma, and developed the website by React.js. We use Amazon AWS S3 to store the user data securely and host the website on Vercel.</p>
            ...
            <section id="test" ref={sectionRefs.current.test}>
                <h2>4 - Field Study</h2>
                <p>Next, we decided to recruit <b>10 participants</b> in North America to join our <b>8-week</b> field deployment study. To ensure the robustness of Olly, our team members have used our own Kindle data to interact with the system before deployment.</p>
                <p>The field study is currently running. It will end in mid June 2024, and we aim to have an one-hour long closing interview with them to learn their experience of using Olly. More details will be shared once we publish our results in a formal research paper.</p>
            </section>
