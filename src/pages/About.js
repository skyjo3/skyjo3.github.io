  ...
  <div className="container">
    ...
    <div className="more-background-container">
        <div className="more-container">
          ...
          />
          <p>I currently work as a senior design technologist in the design systems team at <a href="https://www.instacart.com/company/about-us" target="_blank">Instacart</a>, which is North America's leading grocery technology company, connecting more than 25 million people across the U.S.
          and Canada with same-day delivery from over 80,000 stores.</p>
